...
class ChartLine2Widget extends StatelessWidget {
  final List<charts.Series> seriesList;
  final bool animate;

  ChartLine2Widget(this.seriesList, {this.animate});

  /// Creates a [LineChart] with sample data and no transition.
  factory ChartLine2Widget.withData(title, data) {
    return new ChartLine2Widget(
